...
return new class extends Migration {
    ...
    {
        Schema::table('industrial_assets', function (Blueprint $t) {
            $t->string('asset_type')->default('card');
        ...
        Schema::table('industrial_subsectors', function (Blueprint $t) {
            $t->foreignId('visual_sector_id')->nullable()->constrained('industrial_sectors')->nullOnDelete();
        });
        Schema::table('industrial_role_profiles', function (Blueprint $t) {
            $t->string('career_level')->nullable();
        });
    }
