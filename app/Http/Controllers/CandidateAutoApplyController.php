...
class CandidateAutoApplyController extends Controller
{
    public function update(Request $r)
    {
        abort_unless($r->user()->role_code === 1 || $r->user()->role === 'student', 403);
        $d = $r->validate(['enabled' => 'nullable|boolean', 'minimum_match_score' => 'required|integer|min:50|max:100', 'daily_limit' => 'required|integer|min:1|max:10']);
