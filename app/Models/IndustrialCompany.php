...
class IndustrialCompany extends Model
{
    ...
    protected $fillable = ['industrial_area_id', 'name', 'slug', 'industry', 'sector', 'plant_name', 'website', 'description', 'is_verified', 'is_active', 'source_name', 'source_url', 'last_verified_at', 'verification_status', 'facility_type'];

    protected $casts = ['industrial_area_id' => 'integer', 'last_verified_at' => 'datetime', 'is_verified' => 'boolean', 'is_active' => 'boolean'];
...
public function sources(){return $this->hasMany(IndustrialCompanySource::class,'industrial_company_id');}
}
