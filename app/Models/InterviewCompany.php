...
class InterviewCompany extends Model
{
    ...
    {
        return $this->hasMany(InterviewRole::class, 'company_id');
    }
    public function experiences()
    {
        return $this->hasMany(InterviewExperience::class, 'company_id');
    }
    public function packages()
    {
        return $this->hasMany(InterviewPackage::class, 'company_id');
    }
}
