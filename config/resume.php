...
return [
    'degrees' => [
        ...
        'Bachelor of Science', 'Bachelor of Science - Data Science',
        'Bachelor of Science - Artificial Intelligence and Machine Learning',
        'Bachelor of Technology', 'Bachelor of Technology - Data Science',
        ...
        'Master of Business Administration', 'Master of Business Administration - Finance',
        ...
        'Master of Laws', 'Master of Pharmacy', 'Master of Science',
        'Master of Science - Data Science',
        'Master of Science - Artificial Intelligence and Machine Learning',
        'Master of Technology', 'Master of Technology - Data Science',
    ...
    'companies' => [
        'Accenture', 'Adobe', 'Amazon', 'Apple', 'Atlassian', 'Bosch', 'Capgemini',
        'Cisco', 'Cognizant', 'Dell Technologies', 'Deloitte', 'Drish Infotech',
        'FCS Software Solutions', 'Figma', 'Google', 'HCLTech', 'HubSpot', 'IBM',
        'Infosys', 'Intel', 'Microsoft', 'Nagarro', 'Net Solutions',
        'NovoInvent Software Pvt Ltd', 'Okta', 'Oracle', 'Quark', 'Red Hat',
        'Sebiz Infotech', 'Simform', 'SoftProdigy', 'Stripe',
        'Tata Consultancy Services', 'Tech Mahindra', 'ToXSL Technologies',
        'Twilio', 'Wipro', 'XenonStack',
    ],
    'templates' => [
