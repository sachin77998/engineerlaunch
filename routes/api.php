...
Route::middleware(['throttle:discovery', CacheDiscoveryResponses::class])->prefix('jobs')->name('api.')->group(function () {
    ...
    Route::get('/{id}', [JobController::class, 'show'])->whereNumber('id')->name('jobs.show');
});

Route::middleware(['throttle:discovery', CacheDiscoveryResponses::class])->prefix('companies')->name('api.')->group(function () {
    ...
    Route::get('/{id}', [CompanyController::class, 'show'])->whereNumber('id')->name('companies.show');
});

Route::middleware(['throttle:discovery', CacheDiscoveryResponses::class])->prefix('technologies')->name('api.')->group(function () {
    ...
    Route::get('/{id}', [TechnologyController::class, 'show'])->whereNumber('id')->name('technologies.show');
});

Route::get('/search/suggestions', SearchSuggestionController::class)
    ->middleware(['throttle:discovery', CacheDiscoveryResponses::class])
...
Route::prefix('auth')->middleware('throttle:auth-api')->group(function () {
    ...
    Route::post('/registration/verify', [RoleAuthController::class, 'verifyRegistration']);
